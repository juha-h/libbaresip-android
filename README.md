...
This project shows how to build and install libraries needed by https://github.com/juha-h/baresip-studio baresip+ application on Debian 13 using Android NDK.
